...
VehicleZoneDistribution.ranger.vehicles["Base.ATAJeepRubicon"] = {index = -1, spawnChance = 2}
VehicleZoneDistribution.ranger.vehicles["Base.ATAJeepArcher"] = {index = -1, spawnChance = 1}


VehicleZoneDistribution.junkyard.vehicles["Base.ATAJeepClassic"] = {index = -1, spawnChance = 1}
VehicleZoneDistribution.junkyard.vehicles["Base.ATAJeepRubicon"] = {index = -1, spawnChance = 1}
VehicleZoneDistribution.junkyard.vehicles["Base.ATAJeepArcher"] = {index = -1, spawnChance = 1}

VehicleZoneDistribution.trafficjamw.vehicles["Base.ATAJeepRubicon"] = {index = -1, spawnChance = 0.5}
VehicleZoneDistribution.trafficjamw.vehicles["Base.ATAJeepClassic"] = {index = -1, spawnChance = 0.5}
VehicleZoneDistribution.trafficjamw.vehicles["Base.ATAJeepArcher"] = {index = -1, spawnChance = 0.5}

VehicleZoneDistribution.trafficjame.vehicles["Base.ATAJeepRubicon"] = {index = -1, spawnChance = 0.5}
VehicleZoneDistribution.trafficjame.vehicles["Base.ATAJeepClassic"] = {index = -1, spawnChance = 0.5}
VehicleZoneDistribution.trafficjame.vehicles["Base.ATAJeepArcher"] = {index = -1, spawnChance = 0.5}

VehicleZoneDistribution.trafficjamn.vehicles["Base.ATAJeepRubicon"] = {index = -1, spawnChance = 0.5}
VehicleZoneDistribution.trafficjamn.vehicles["Base.ATAJeepClassic"] = {index = -1, spawnChance = 0.5}
VehicleZoneDistribution.trafficjamn.vehicles["Base.ATAJeepArcher"] = {index = -1, spawnChance = 0.5}

VehicleZoneDistribution.trafficjams.vehicles["Base.ATAJeepRubicon"] = {index = -1, spawnChance = 0.5}
VehicleZoneDistribution.trafficjams.vehicles["Base.ATAJeepClassic"] = {index = -1, spawnChance = 0.5}
VehicleZoneDistribution.trafficjams.vehicles["Base.ATAJeepArcher"] = {index = -1, spawnChance = 0.5}
